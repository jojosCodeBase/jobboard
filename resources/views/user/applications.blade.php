      ...
      <ul class="job-listings mb-5">
        @foreach ($applications as $app)
            <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                <a href="{{ route('single.job', $app->job_id)}}"></a>
                <div class="job-listing-logo">
                <img src="{{asset('assets/images/'.$app->job_image.'')}}" alt="Free Website Template by Free-Template.co" class="img-fluid">
                </div>
                ...
                <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
                    <span class="icon-room"></span> {{ $app->job_region }}
                </div>
                <div class="job-listing-meta">
                    <span class="badge badge-danger">{{ $app->job_type }}</span>
                </div>
                </div>
            </li>
        @endforeach
